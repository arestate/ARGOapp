...
public class EnquiryListAdapter1 extends RecyclerView.Adapter<EnquiryListAdapter1.ViewHolder>{
    private List<EnquiryResultVo> listdata;

    OnItemClickListner mListener;

   // RecyclerView recyclerView;
    public EnquiryListAdapter1(List<EnquiryResultVo> listdata, OnItemClickListner listner) {
